...
layout = [[sg.T('NSARA Contest Logger', size = (20,2), justification='right')],
        ...
        [sg.B('Save', tooltip = 'Save this QSO to the log', size = (15,1), pad = (80, 0)), sg.B('Clear', tooltip = 'Clear all fields', size = (15,1), pad = (80, 0)), sg.B('Exit', tooltip = 'Exit the program', size = (15, 1), pad = (80, 1))],
